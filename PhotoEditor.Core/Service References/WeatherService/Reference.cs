...
namespace PhotoEditor.Core.WeatherService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GlobalWeatherSoapChannel : PhotoEditor.Core.WeatherService.GlobalWeatherSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GlobalWeatherSoapClient : System.ServiceModel.ClientBase<PhotoEditor.Core.WeatherService.GlobalWeatherSoap>, PhotoEditor.Core.WeatherService.GlobalWeatherSoap {
        ...
        System.IAsyncResult PhotoEditor.Core.WeatherService.GlobalWeatherSoap.BeginGetWeather(string CityName, string CountryName, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetWeather(CityName, CountryName, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string PhotoEditor.Core.WeatherService.GlobalWeatherSoap.EndGetWeather(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetWeather(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((PhotoEditor.Core.WeatherService.GlobalWeatherSoap)(this)).BeginGetWeather(CityName, CountryName, callback, asyncState);
        }
        
        private object[] OnEndGetWeather(System.IAsyncResult result) {
            string retVal = ((PhotoEditor.Core.WeatherService.GlobalWeatherSoap)(this)).EndGetWeather(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult PhotoEditor.Core.WeatherService.GlobalWeatherSoap.BeginGetCitiesByCountry(string CountryName, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetCitiesByCountry(CountryName, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string PhotoEditor.Core.WeatherService.GlobalWeatherSoap.EndGetCitiesByCountry(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetCitiesByCountry(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((PhotoEditor.Core.WeatherService.GlobalWeatherSoap)(this)).BeginGetCitiesByCountry(CountryName, callback, asyncState);
        }
        
        private object[] OnEndGetCitiesByCountry(System.IAsyncResult result) {
            string retVal = ((PhotoEditor.Core.WeatherService.GlobalWeatherSoap)(this)).EndGetCitiesByCountry(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override PhotoEditor.Core.WeatherService.GlobalWeatherSoap CreateChannel() {
        ...
        private class GlobalWeatherSoapClientChannel : ChannelBase<PhotoEditor.Core.WeatherService.GlobalWeatherSoap>, PhotoEditor.Core.WeatherService.GlobalWeatherSoap {
            
            public GlobalWeatherSoapClientChannel(System.ServiceModel.ClientBase<PhotoEditor.Core.WeatherService.GlobalWeatherSoap> client) : 
                    base(client) {
            }
